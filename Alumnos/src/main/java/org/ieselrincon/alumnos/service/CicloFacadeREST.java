 ...
 */
package org.ieselrincon.alumnos.service;
...
import org.ieselrincon.alumnos.Ciclo;
 ...
 */
@Stateless
@Path("org.ieselrincon.alumnos.ciclo")
public class CicloFacadeREST extends AbstractFacade<Ciclo> {

    @PersistenceContext(unitName = "org.ieselrincon_Alumnos_war_1.0-SNAPSHOTPU")
    ...
    @Path("{id}")
    @Consumes(MediaType.APPLICATION_JSON)
    public void edit(@PathParam("id") Integer id, Ciclo entity) {
        super.edit(entity);
    }
